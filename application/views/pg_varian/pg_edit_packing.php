<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Edit Pergantian Varian Packing</h1>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active" aria-current="page"> <a href="<?= base_url('pergantian_varian_packing');?>"> <i
                        class="fas fa-arrow-left"></i> Pergantian Varian</a></li>
            <li class="breadcrumb-item"><a href="<?= base_url('pergantian_varian_packing/detail/'.$data->tanggal.'/'.$data->shift) ?>"> 
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="user" action="<?= base_url('pergantian_varian_packing/edit/'.$data->uuid) ?>" method="post">
                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <a href="<?= base_url('pergantian_varian_packing/detail/'.$data->tanggal.'/'.$data->shift) ?>"
