<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Permintaan Bahan Baku Filler</h1>
        <a href="<?= base_url('bahan_filler/tambah'); ?>" class="btn btn-md btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white"></i> Tambah</a>
    </div>
                        ...
                        foreach ($data as $row) {
                            ...
                            <tr>
                                ...
                                <td class='align-middle text-center'>
                                    <a href="<?= base_url('bahan_filler/detail_'.$row->tgl); ?>"
                                    class="btn btn-md btn-success shadow-sm mt-2"><i class="fa fa-info fa-sm text-white mr-1"></i>
                                    Detail Permintaan</a>
                                    <a href="<?= base_url('bahan_filler/form_'.$row->tgl); ?>"
