<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <!-- Page Heading -->
        <h3 class="h3 mb-2 text-gray-800">Detail Permintaan Sparepart</h3>
        <?php
            $now = date('Y-m-d');
                if ($data[0]->tanggal == $now) {
            ?>
            <a href="<?= base_url('bahan_sparepart/detail_'.$data[0]->tanggal.'/tambah'); ?>" class="btn btn-md btn-primary shadow-sm"><i
                class="fas fa-plus fa-sm text-white"></i> Tambah</a>
        <?php } ?>
    </div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url('bahan_sparepart') ?>"><i class="fas fa-arrow-left"></i>
                    Permintaan Sparepart</a></li>
                ...
                <table class="table table-success mb-4">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td width="15">:</td>
                            <td class='font-weight-bold border-bottom-0' style="color: #219b0b;shadow-sm;">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                    <thead class="table bg-info text-light">
                        <tr>
                            ...
                            <th class='align-middle text-center' width='15%'>Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        <tr>
                            ...
                            <td class='align-middle text-center'>
                                <a href="<?= base_url('bahan_sparepart/'.$row->uuid); ?>"
            ...
            <div class="col mt-3">
                <a href="<?= base_url('bahan_sparepart') ?>" class="btn btn-md btn-danger">
...
$(document).ready(function() {
    $(document).on('click', '.btn-approve', function(event) {
        ...
        $.post('<?= base_url('bahan_baku/approval'); ?>/' + uuid + '/' + area, function(res) {
