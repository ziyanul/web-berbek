<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Status Pengajuan Repair & New Part</h1>
...
<div class="card shadow mb-4">
    <div class="card-body">
        <form class="user" action="<?= base_url('partrequest/status_part/'.$data->uuid) ?>" method="post">
                    ...
                    <div class="row mb-3 mb-sm-0">           
                        <div class="col-sm-8 mb-3 mb-sm-0">
                            ...
                            <select class="form-control <?= form_error('status') ? 'invalid' : '' ?>" name="status">
                                ...
                                <?php if ($data->jenis == 1): ?>
                                <option value="2">Release Komdif (buat PO)</option>
