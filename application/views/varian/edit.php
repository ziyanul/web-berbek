            ...
            <form action="<?= base_url('Varian/edit/' . $data->uuid) ?>" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" name="berat" step="0.01" placeholder="0.000"
                            value="<?= $data->berat ?>">
                    </div>

                    <div class="form-group col-md-6">
                        <label>Panjang (Cm)</label>
                        <input type="number" class="form-control" name="panjang" step="0.01" placeholder="0.000"
                            value="<?= $data->panjang ?>">
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" name="kontainer_kg" step="0.01" placeholder="0.000"
                            value="<?= $data->kontainer_kg ?>">
                    </div>

                    <div class="form-group col-md-6">
                        <label>Berat Produk / Box (Kg)</label>
                        <input type="number" class="form-control" name="box_kg" step="0.001" placeholder="0.000"
                            value="<?= $data->box_kg ?>">
                    </div>
                ...
                <!-- Standart per batch -->
                <h5 class="border-bottom pb-2 mt-4 mb-3">Standard</h5>

                <div class="form-row">

                    <div class="form-group col-md-6">
                        <label>PVDC (ROLL)</label>
                        <input type="number" class="form-control" name="pvdc_batch" step="0.001" placeholder="0.000"
                            value="<?= $data->pvdc_batch ?>">
                    </div>
