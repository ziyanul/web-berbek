    ...
    <div class="container-fluid">
    	...
    	<!-- Page Heading -->
    	<h1 class="h3 mb-2 text-gray-800">Ubah Stock Rework</h1>
    	...
    	<div class="card shadow mb-4">
    		<div class="card-body">
    			<form class="user" action="<?= base_url('rework/edit/'. $data->uuid);?>" method="post">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <select class="form-control <?= form_error('varian') ? 'invalid' : '' ?>" name="varian">
                                ...
                                foreach ($varian as $row) {
                                    $selected = ($row->uuid == $data->varian_uuid) ? 'selected' : '';
                                    ?>
                                    <option value="<?= $row->uuid; ?>" <?= $selected; ?>><?= $row->varian; ?></option>
                                    <?php
                                }
                                ?>
                            </select>
    ...
    <div class="col-sm-6 mb-3 mb-sm-0">
        ...
        <input type="text" name="kode_rework" class="form-control <?= form_error('kode_rework') ? 'invalid' : '' ?>" 
               placeholder="contoh: OI24701AA0" value="<?= $data->kode_rework; ?>" 
            ...
            <?= form_error('kode_rework') ?>
                  ...
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                       ...
                       <input type="number" name="berat" class="form-control <?= form_error('berat') ? 'invalid' : '' ?>" value="<?= $data->berat; ?>" >
