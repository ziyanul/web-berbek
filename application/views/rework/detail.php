                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td class='font-weight-bold border-bottom-0' style="color: #219b0b;">
                                ...
                                <a href="#" data-tanggal_kode="<?= $row->tanggal_kode; ?>" data-role="1"
                        ...
                        <tr>
                            ...
                            <td class='font-weight-bold border-bottom-0' style="color: #219b0b;">
                                ...
                                <a href="#" data-tanggal_kode="<?= $row->tanggal_kode; ?>" data-role="2"
                                    class="btn btn-approve btn-success shadow-sm" data-toggle="tooltip"
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                foreach ($data as $row) {
                    ?>
                        <tr>
                            ...
                            <?php if (empty($row->foreman_uuid)): ?>
                            <td>
                                <a href="<?= base_url('rework/editpakai/' . $row->uuid); ?>"
                ...
                if ($row->acc_qc == null && $this->session->userdata('type')==1 || $this->session->userdata('type')==2){ ?>
                                    <a href="<?= base_url('rework/acc_qc/' . $row->uuid); ?>"
                                    class="btn btn-md btn-success shadow-sm btn-block">ACC</a>
                                <?php } ?>
                            </td>
                            <?php endif; ?>
                        </tr>
