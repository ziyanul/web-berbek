<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h2 class="h2 mb-2 text-gray-800">Tambah Data Reject Permesin Di Retort</h2>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <form class="user" action="<?= base_url('rt_rjmesin/tambahcek/' . $nav->kode_batch) ?>" method="post" id="mesinForm">
                ...
                <div id="badproInputs">
                    <div class="row mb-4 badpro-row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="float" class="form-control" name="reject[]" min="0" required>
                            <div class="invalid-feedback">
                                <!-- Pesan error reject -->
                            </div>
                        </div>
                ...
                <div class="row mb-4">
                    <div class="col-sm-4">
                        <button type="button" class="btn btn-md btn-success" id="addBadproBtn">
    ...
    <script>
        ...
        document.getElementById('addBadproBtn').addEventListener('click', function() {
            ...
            <button type="button" class="btn btn-md btn-danger removeBadproBtn">
