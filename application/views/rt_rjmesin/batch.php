                    ...
                    <table class="table table-success mb-4">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="15">:</td>
                                <td class="font-weight-bold"><?= $data[0]->nama_varian; ?> ( <?= $data[0]->keterangan ?> )</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class='font-weight-bold border-bottom-0' style="color: #219b0b;">
                                    <?php if (empty($data[0]->fr_rt_rjmesin)) : ?>
                                        ...
                                        <a href="" data-uuid="<?= $data[0]->planning_uuid; ?>" class="btn btn-approve btn-success shadow-sm" data-toggle="tooltip" data-placement="top" title="Approval">
                                ...
                                <tr>
                                    ...
                                    <td class='font-weight-bold border-bottom-0' style="color: #219b0b;">
                                        <?php if (empty($data[0]->spv_name)) : ?>
                                            <!-- Tampilkan tombol jika spv_uuid kosong -->
                                            <a href="#" data-uuid="<?= $data[0]->planning_uuid; ?>" class="btn btn-approve-spv btn-success shadow-sm" data-toggle="tooltip" data-placement="top" title="Approval">
                                                <i class="fa fa-check-circle mr-2"></i> ACC
                                            </a>
                                        <?php else : ?>
                                            <!-- Tampilkan fullname jika sudah di-ACC -->
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('rt_rjmesin/tambahcek/' . $row->kode_batch); ?>" class="btn btn-md btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white mr-2"></i> Reject Mesin</a>
                                        <a href="<?= base_url('rt_rjmesin/detailreject/' . $row->kode_batch); ?>" class="btn btn-md btn-success shadow-sm"><i class="fa fa-book fa-sm text-white mr-2"></i>Detail Reject Per Batch</a>
                                    </td>
                                </tr>
                            <?php
                                $no++;
