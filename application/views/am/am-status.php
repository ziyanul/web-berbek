<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Perubahan Status AM</h1>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url('am') ?>"><i class="fas fa-arrow-left mr-2"></i>Monitoring AM</a></li>
...
<div class="card shadow mb-4">
    <div class="card-body">
        ...
        <div class="row">
            <div class="col">
                <form class="user" action="<?= base_url('am/'.($this->uri->segment(2)=='tpm'?'tpm/':'').'status/'.$data->uuid) ?>" method="post">
                    ...
                    <div class="row mb-3 mb-sm-0">           
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <select class="form-control <?= form_error('status') ? 'invalid' : '' ?>" name="status" id="status">
                                ...
                                <option value="2" <?= set_select('status', 2);?>>AM Ulang</option>
