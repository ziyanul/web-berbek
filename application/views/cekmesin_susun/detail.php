<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h2 class="h2 mb-2 text-gray-800">Detail dan Aproval Pengecekan Mesin Susun</h2>
    </div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url('cekmesin_susun') ?>"><i
                        class="fas fa-arrow-left mr-2"></i>Pengecekan Mesin Susun</a></li>
    ...
    <div class="card shadow mb-4">
        ...
        ?>
            ...
            <div class="row mt-3">
                <div class="col">
                    <a href="<?= base_url('cekmesin_susun') ?>" class="btn btn-md btn-danger">
...
$(document).ready(function() {
    $(document).on('click', '.btn-check-oke', function(event) {
        ...
        $.post('<?= base_url('cekmesin_susun/check_akhir/'); ?>' + cek_uuid, {
            checklist: checklist
        }, function(res) {
    ...
    $(document).on('submit', '.form-keterangan', function(event) {
        ...
        $.post('<?= base_url('cekmesin_susun/keterangan/'); ?>' + uuid, {
                uuid: uuid,
    ...
    $(document).on('click', '.btn-approve-fr, .btn-approve-spv', function(event) {
        ...
        var url = isForeman ?
            '<?= base_url('cekmesin_susun/approval_cekmesin2'); ?>/' + uuid + '/' + area :
            '<?= base_url('cekmesin_susun/approval_cekmesin'); ?>/' + uuid + '/' + area;
