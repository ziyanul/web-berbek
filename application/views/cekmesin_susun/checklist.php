<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Check List Pengecekan Mesin Awal Proses</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="user" action="<?= base_url('cekmesin_susun/checklist/'. $data->uuid); ?>" method="post">
                <div class="row">
                    <div class="col-sm-6 mb-4">
                        <label class="form-label">Nama Area <span class="text-danger">*</span></label>
                        <input class="form-control" type="text" name="area_name" value="SUSUN" readonly>
                        <input type="hidden" name="area_uuid" value="<?php 
                            foreach ($area as $a) {
                                if ($a->uuid === $this->susun) { 
                                    echo $a->uuid; 
                                }
                            }
                        ?>">
...
$(document).ready(function() {
    ...
    $.get('<?= base_url('cekmesin_susun/get_mesin_by_area/'); ?>' + area_uuid + '/' + t_planning_uuid,
        function(res) {
    ...
    $('select[name="mesin"]').change(function() {
        ...
        $.get('<?= base_url('cekmesin_susun/get_kegiatan_by_mesin/'); ?>' + mesin_uuid, function(res) {
