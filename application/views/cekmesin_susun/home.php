<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4 mr-2">
        <h2 class="h2 mb-2 text-gray-800">Pengecekan Mesin Susun</h2>
                ...
                <table class="table table-bordered" id="datatables" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center"><?= $row->jumlah_mesin ?> dari 4</td>
                            <td>
                                <a href="<?= base_url('cekmesin_susun/'.$row->uuid); ?>"
                                ...
                                <a href="<?= base_url('cekmesin_susun/detail-'.$row->uuid.'/'. $susun_uuid); ?>"
                                ...
                                <a href="<?= base_url('cekmesin_susun/form-'.$row->uuid.'/'. $susun_uuid); ?>"
