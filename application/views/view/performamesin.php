...
<div class="container-fluid">
	<div class="card shadow mt-5">
		<div class="card-header">
			<div class="d-sm-flex align-items-center justify-content-between">
				<h5 class="h3" id="modalTambahLabel">Data Performa Per Mesin</h5>
			...
			<!-- Modal -->
			<div class="modal fade" data-backdrop="static" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="modalTambahLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header bg-info">
							<h5 class="h3 modal-title text-light" id="modalTambahLabel">Tambah Data Performa Mesin</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<form action="<?= base_url('view/performamesin') ?>" method="post">
				...
				<table class="table table-bordered" id="datatables" width="100%" cellspacing="0">
					<thead class="table bg-info text-light">
						<tr>
							...
							<th class="font-weight-bold">Performa</th>
						...
						foreach ($data as $row) {
							...
							<tr>
								...
								<td>                           
									...
									<button type="button" class="btn btn-warning btn-block editBtn" data-toggle="modal" data-target="#modalEditPerformaMesin<?= $row->uuid ?>" data-uuid="<?= $row->uuid ?>">
										<i class="fa fa-edit"></i> Edit
									</button>

									<!-- Modal -->
									<div class="modal fade" data-backdrop="static" id="modalEditPerformaMesin<?= $row->uuid ?>" tabindex="-1">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form id="editForm" method="POST" action="<?= base_url('view/editperforma') ?>">
													...
													<div class="modal-body">
														...
														<div class="mb-3">
															...
															<input type="number" name="performa" id="edit_performa" class="form-control" step="0.01">
														</div>
													</div>
  ...
  // Ketika tombol edit diklik
    ...
    $.ajax({
    	url: '<?= base_url('view/get_data_by_uuid') ?>',
    	type: 'POST',
    	data: { uuid: uuid },
    	dataType: 'json',
    	success: function(data) {
        // Pastikan data tersedia
          ...
          $('#modalEditPerformaMesin' + uuid + ' #edit_performa').val(data.performa); // Menampilkan nilai performa untuk modal yang sesuai
    ...
    Swal.fire({
    	...
    	if (result.isConfirmed) {
    		$.get('<?= base_url('view/hapus_performa/'); ?>' + data_uuid, function (res) {
