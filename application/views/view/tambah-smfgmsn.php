    ...
    <div class="card shadow mt-4">
        <div class="card-header">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h5 class="h3" id="modalTambahLabel">Tambah Data Bad Produk SMFG / Mesin</h5>
            </div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?= base_url('view/smfgmsn') ?>">
                            <i class="fas fa-arrow-left mr-2"></i>Data SMFG per Mesin
                        </a>
                    </li>
        ...
        <div class="card-body">
            <form action="<?= site_url('view/tambah_smfgmsn') ?>" method="post">
                <div class="container">
                    <div class="row">
                        <!-- Kolom 1: Varian -->
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="badpro-select">Mesin</label>
                                <select id="badpro-select" name="mesin_uuid" class="form-control" required>
                    ...
                    <a class="btn btn-danger ml-3" href="<?= base_url('view/smfgmsn') ?>">
