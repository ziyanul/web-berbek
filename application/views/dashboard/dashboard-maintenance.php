                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="<?= base_url('pm?status=urgent') ?>" class="text-decoration-none">
                        ...
                        <!-- SPAREPART -->
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="<?= base_url('sparepart/lifetime') ?>" class="text-decoration-none">
                        ...
                        <!-- REPAIR -->
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="<?= base_url('repair?status=open') ?>" class="text-decoration-none">
