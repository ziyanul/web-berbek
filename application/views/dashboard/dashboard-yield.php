                                            ...
                                            <?php if (!empty($monitoring_filkar)) : ?>
                                                <?php foreach ($monitoring_filkar as $row) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?= number_format((float)$row->adonan_formula - $row->filkar_kg, 2) ?>
                                                        </td>
                                                        <td>
                            ...
                            <div class="dashboard-card-body">
                                <div class="table-responsive">
                                    <table class="table table-dashboard">
                                        ...
                                        <tbody>
                                            <?php if (!empty($monitoring_sortasi)) : ?>
                                                <?php foreach ($monitoring_sortasi as $row) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?= number_format($row->sortasi_rework, 3) ?>
                                                        </td>
                                                        <td>
                                                            <?= number_format($row->sortasi_reject, 3) ?>
                                                        </td>
                                                        <td>
                                                            <b>
                                                                <?= number_format($row->sortasi_bad, 3) ?>
                                                            </b>
                                                        </td>
                                                        <td>
                                                            <b>
                                                                <?= number_format($row->bad_persen, 3) ?> %
                                                            </b>
                                                        </td>
                                                        <td>
                                                            <?= number_format($row->yield_sortasi, 3) ?> %
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php else : ?>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td>TOTAL</td>
                                                <td>
                                                    <?= number_format($total_sortasi->sortasi_kg ?? 0) ?>
                                                </td>
                                                <td>
                                                    <?= number_format($total_sortasi->release_kg ?? 0) ?>
                                                </td>
                                                <td>
                                                    <?= number_format($total_sortasi->blm_sortir_kg ?? 0) ?>
                                                </td>
                                                <td>
                                                    <?= number_format($total_sortasi->sortasi_rework ?? 0, 3) ?>
                                                </td>
                                                <td>
                                                    <?= number_format($total_sortasi->sortasi_reject ?? 0, 3) ?>
                                                </td>
                                                <td>
                                                    <?= number_format($total_sortasi->sortasi_bad ?? 0, 3) ?>
                                                </td>
                                                <td>
                                                    <?= number_format($total_sortasi->bad_persen ?? 0, 3) ?>
                                                </td>
                                                <td>
                                                    <?= number_format($total_sortasi->yield_sortasi ?? 0, 3) ?> %
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
                        ...
                        <div class="card-modern">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h5 class="font-weight-bold mb-0 text-info"><i
                                            class="fas fa-bolt text-success mr-2"></i>Shortcut</h5>
                                </div>
                                <div class="shortcut-grid">
                                    <a href="<?= base_url('filler/planning') ?>" class="shortcut-link"><i
                                            class="fas fa-route"></i><span>PLAN PRODUKSI</span></a>
                                    <a href="<?= base_url('analisa') ?>" class="shortcut-link"><i
                                            class="fas fa-chart-bar"></i><span>ANALISA</span></a>
                                    <a href="<?= base_url('mpusage') ?>" class="shortcut-link"><i
                                            class="fas fa-cogs"></i><span>MP</span></a>
                                    <a href="<?= base_url('counter') ?>" class="shortcut-link"><i
                                            class="fas fa-industry"></i><span>FILLER</span></a>
                                    <a href="<?= base_url('filkar') ?>" class="shortcut-link"><i
