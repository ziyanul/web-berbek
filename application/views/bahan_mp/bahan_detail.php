<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <!-- Page Heading -->
        <h3 class="h3 mb-2 text-gray-800">Detail Permintaan Bahan Baku MP</h3>
        <?php
        $now = date('Y-m-d');
        if ($data[0]->tanggal == $now) {
            ?>
            <a href="<?= base_url('bahan_mp/detail_'.$data[0]->tanggal.'/tambah'); ?>" class="btn btn-md btn-primary shadow-sm"><i
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <div class="table-responsive">
                            ...
                            foreach ($data as $row) {
                                ...
                                <tr>
                                    ...
                                    <td class='align-middle text-center'>
                                        ...
                                        <a href="<?= base_url('bahan_mp/'.$row->uuid); ?>"
                    ...
                    <div class="col mt-3">
                        <a href="<?= base_url('bahan_mp') ?>" class="btn btn-md btn-danger">
        ...
        $.post('<?= base_url('bahan_mp/approval_mp'); ?>/' + uuid + '/' + area, function(res) {
