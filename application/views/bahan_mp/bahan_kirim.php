<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-2 text-gray-800">Penerimaan Bahan Baku MP</h1>
    </div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url('bahan_mp') ?>"><i class="fas fa-arrow-left"></i>
                    Permintaan Bahan Baku MP</a></li>
            <li class="breadcrumb-item"><a href="<?= base_url('bahan_mp/detail_'. $nav->tanggal) ?>"></i> Detail
                    Permintaan Bahan Baku MP</a></li>
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class='align-middle text-center'><?= !empty($modified) ? date('d M Y / H:i', strtotime($modified)) : '-'; ?>
                            <td class='align-middle text-center'><?= !empty($row->qc_keterangan) ? $row->qc_keterangan : '-'; ?></td>
                            </td>
                            <td class='align-middle text-center'>
                                ...
                                <span class="badge badge-danger" style="font-size: 16px; padding: 5px 10px;">QC Tolak</span>
                                <?php else: ?>
                                <!-- Nilai kondisi NULL, Belum ACC QC -->
                                <span class="badge badge-warning" style="font-size: 16px; padding: 5px 10px;">Belum ACC QC</span>
                                <?php endif; ?>
                            </td>
                        </tr>
                            <?php
...
$(document).ready(function () {
    $(document).on('click', '.btn-check-approval', function (event) {
        ...
        $.get('<?= base_url('bahan_mp/diterima/'); ?>' + uuid, function (res) {
