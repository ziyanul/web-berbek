    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="table-responsive">
                ...
                foreach ($data as $row) {
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('Bahan/edit/' . $row->uuid); ?>"
                                    class="btn btn-sm btn-warning shadow-sm btn-block"><i class="fa fa-edit"></i></a>
                                <a href="javascript:void(0)" class="btn btn-sm btn-danger shadow-sm btn-block btn-hapus"
                                    data-url="<?= base_url('Bahan/hapus/' . $row->uuid); ?>">
             ...
             ?>
                        <tr>
                            <form class="user" action="<?= base_url('Bahan/simpan') ?>" method="post">
                                <td>#
                                </td>
                                ...
                                <td><input type="text" name="bahan"
                                        class="form-control <?= form_error('bahan') ? 'invalid' : '' ?>"
                                        value="<?= set_value('bahan'); ?>" placeholder="">
                                ...
                                <td><input type="text" name="keterangan"
                                        ...
                                        value="<?= set_value('keterangan'); ?>" placeholder="boleh kosong">
                                    <div
                                        class="invalid-feedback <?= !empty(form_error('keterangan')) ? 'd-block':'';?>">
