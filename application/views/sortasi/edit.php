                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="jenis_sortasi_uuid" class="form-control" required>
                                        ...
                                        <option value="<?= $jenis->uuid ?>"
                                            <?= $jenis->uuid ==	$data->jenis_sortasi_uuid ? 'selected' : '' ?>>
...
================================== -->
                    ...
                    <div class="card border-left-info mb-4">
                        ...
                        <div class="card-header bg-light">
                            <b>WIP yang Digunakan</b>
                        </div>

                        <div class="card-body">

                            <?php foreach ($wip as $i => $row): ?>

                            <?php
								$dipakai = (float) $row->dipakai_edit;
								?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" name="wip_uuid[]" value="<?= $row->uuid ?>">

                                    <label>
                                        <?= $row->jenis_wip ?>
                                    </label>

                                    <input type="text" class="form-control" value="<?= $row->jenis_wip ?>" readonly>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="wip_jumlah[]" class="form-control" min="0" step="1"
                                        value="<?= $dipakai ?>">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" name="release_box" class="form-control" min="0" step="1"
                                        value="<?= $edit_output['RELEASE'] ?>">
                                </div>

                                <div class="col-md-3">
                                    <label>Tampung (Box)</label>

                                    <input type="number" name="output_tampung" class="form-control" min="0" step="1"
                                        value="<?= $edit_output['TAMPUNG'] ?>">
                                </div>

                                <div class="col-md-3">
                                    <label>Kasar (Box)</label>

                                    <input type="number" name="output_kasar" class="form-control" min="0" step="1"
                                        value="<?= $edit_output['KASAR'] ?>">
                                </div>

                                <div class="col-md-3">
                                    <label>Cuci (Box)</label>

                                    <input type="number" name="output_cuci" class="form-control" min="0" step="1"
                                        value="<?= $edit_output['CUCI'] ?>">
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time" name="mulai" class="form-control"
                                            value="<?= set_value('mulai', $data->jam_mulai) ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time" name="selesai" class="form-control"
                                            value="<?= set_value('selesai', $data->jam_selesai) ?>">
                                        <small class="text-danger">
                                            <?= form_error('selesai') ?>
                                        </small>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type=number step="1" name="jml_mp" class="form-control"
                                            value="<?= set_value('jml_mp', $data->jml_mp) ?>">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="badpro_uuid[]" class="form-control badproSelect"
                                                        required>
                                                        <option value="">
                                                            Pilih Bad Produk
                                                        </option>
                                                        <?php foreach ($badpro as $b) : ?>
                                                        <option value="<?= $b->uuid_badpro ?>"
                                                            data-kategori="<?= $b->kategori_nama ?>" <?= ($b->uuid_badpro
																														==
																														$bp->badpro_uuid
																													)
																														? 'selected'
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="0.01" min="0.01" name="badpro_berat[]"
                                                        class="form-control jumlahBad" value="<?= $bp->berat ?>"
                                                        required>
                                                </div>
                                            </div>
                                            <!-- MESIN DOMINAN -->
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="mesin_uuid[<?= $index ?>][]"
                                                        class="form-control mesinDominan" multiple>
