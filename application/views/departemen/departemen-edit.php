...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="user" action="<?= base_url('departemen/edit/'.$dept->uuid);?>" method="post">
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label class="form-label">Nama Departemen</label>
                        <input type="text" name="dept" class="form-control <?= form_error('dept') ? 'invalid' : '' ?>" placeholder="Masukkan Nama Departemen" value="<?= $dept->dept; ?>">
