<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url('drystore/type') ?>"><i class="fas fa-arrow-left"></i>
                    Type Drystore</a></li>
            ...
            <form class="user" action="<?= base_url('drystore/edit_type/' . $data->uuid) ?>" method="post">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="text" name="nama" class="form-control <?= form_error('nama') ? 'invalid' : '' ?>"
                            value="<?= $data->nama; ?>">
                ...
                <div class="row mt-3">
                    <div class="col-sm-6">
                        ...
                        <input type="number" step="0.01" name="std_waste"
                            class="form-control <?= form_error('std_waste') ? 'invalid' : '' ?>"
                            value="<?= $data->std_waste; ?>">
                ...
                <div class="row mt-3">
                    <div class="col-sm-6">
                        ...
                        <?php
                        $selected_varian = explode(',', $data->varian_uuid);
                        ?>
                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <a href="<?= base_url('drystore/type') ?>" class="btn btn-md btn-danger">
