<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Edit Data Jenis Reject Drystore</h1>

    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url('drystore/waste') ?>"><i class="fas fa-arrow-left"></i>  Type Drystore</a></li>
  ...
  <div class="card shadow mb-4">
        <div class="card-body">
            <form class="user" action="<?= base_url('drystore/edit_waste/'.$data->uuid) ?>" method="post">
