                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group bg-light">
                            ...
                            <input
                                ...
                                value="<?= htmlspecialchars($drystore->tanggal); ?>"
                                readonly
                            >
                        </div>
                    </div>
                                            ...
                                            <div class="col-sm-5">
                                                <div class="input-group input-group-sm">
                                                    <input
                                                        ...
                                                        min="0"
                                                        placeholder="0"
                                                        value="<?= $berat > 0 ? htmlspecialchars($berat) : ''; ?>"
                                                    >
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">
                                                            <?= htmlspecialchars($type->satuan); ?>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
...
$(document).ready(function() {
    ...
    // Load release berdasarkan tanggal edit
    const tanggal =
        $('#tanggal').val();
    loadRelease(tanggal);
});
