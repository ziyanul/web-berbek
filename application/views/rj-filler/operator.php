<div class="container-fluid">
   <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h2 class="h2 mb-2 text-gray-800">Data Reject Filler per Operator</h2>
            ...
            <form action="<?= site_url('view/tambah_smfgmsn') ?>" method="post">
                <div class="modal-content">
                    <div class="modal-header bg-info">
                        <h5 class="h3 modal-title text-light" id="modalTambahLabel">Tambah Data Reject Filler Per Operator</h5>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="mesin" name="mesin_uuid" class="form-control" required>
                                            ...
                                            <?php foreach ($mesin as $msn): ?>
                                                <option value="<?= $msn->uuid ?>"><?= $msn->nama_mesin ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-danger ml-3" href="<?= base_url('rj_filler/operator') ?>">
