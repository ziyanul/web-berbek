<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url('area_proses') ?>"><i class="fas fa-arrow-left"></i> Fokus Area</a></li>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="user" action="<?= base_url('area_proses/tambah') ?>" method="post">
                <div class="row">
                    <div class="col-sm-6">
