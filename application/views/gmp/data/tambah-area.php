<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Tambah Area</h1>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url('gmp/area') ?>"><i class="fas fa-arrow-left mr-2"></i>Data ISO/TS</a></li>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="user" action="<?= base_url('gmp/tambaharea') ?>" method="post">
                <div class="row">
                    <div class="col-sm-6">
