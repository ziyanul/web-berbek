...
<div class="d-sm-flex align-items-center justify-content-between mb-4 mt-5">
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Data Lokasi di <?= $area->nama_area;?></h1>
                     ...
                     foreach ($lokasi as $l) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('gmp/kegiatan/'.$l->uuid); ?>" class="btn btn-md btn-info shadow-sm"><i class="fa fa-edit fa-sm text-white mr-2"></i> Data Kegiatan</a>
