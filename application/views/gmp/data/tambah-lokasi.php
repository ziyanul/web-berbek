<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url('gmp/area') ?>"><i class="fas fa-arrow-left mr-2"></i>Data Area</a></li>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="user" action="<?= base_url('gmp/tambahlokasi') ?>" method="post">
                <div class="row">
    ...
    $(document).ready(function () {
        $('select[name="area"]').change(function () {
            ...
            $.get('<?= base_url('gmp/get_area_name/');?>'+val, function (res) {
                ...
                $('input[name="area_name"]').val(data.area);
            })
        })
    })
</script>