<div class="container-fluid">
	<h1 class="h3 mb-2 text-gray-800">Form Permintaan Sparepart </h1>
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="<?= base_url('pengajuan') ?>"><i class="fas fa-arrow-left mr-2"></i> Monitoring Sparepart</a></li>
	...
	<div class="card shadow mb-4">
		<div class="card-body">
			<form class="user" action="<?= base_url('monitor/tambahpengajuan') ?>" method="post" enctype="multipart/form-data">
