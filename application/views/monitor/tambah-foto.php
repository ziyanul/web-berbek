...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Tambah Foto SparePart</h1>
...
<div class="card shadow mb-4">
    <div class="card-body">
        <form class="user" action="<?= base_url('monitor/tambahfoto/'.$data->uuid) ?>" method="post" enctype="multipart/form-data">
