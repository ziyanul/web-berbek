<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url('monitor') ?>"><i class="fas fa-arrow-left mr-2"></i> Data Sparepart</a></li>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <?php
            $action = base_url('monitor/edit/'.$data->monitor_uuid);
            if ($this->uri->segment(2) == 'tpm') {
                $action = base_url('monitor/tpm/edit/'.$data->monitor_uuid);
            }
            ?>
                ...
                <div class="row">
                  <div class="col-sm-6 mb-3">
                    ...
                    <select class="form-control <?= form_error('jadwal') ? 'invalid' : '' ?>" name="jadwal">
                      ...
                      <option value="2" <?= ($data->jadwal == 2) ? 'selected' : ''; ?>>Counter Mesin</option>
                  </select>
