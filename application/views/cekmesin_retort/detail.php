<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h2 class="h2 mb-2 text-gray-800">Detail dan Aproval Pengecekan Mesin Retort</h2>
    </div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url('cekmesin_retort') ?>"><i
                        class="fas fa-arrow-left mr-2"></i>Pengecekan Mesin Retort</a></li>
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                    <thead class="table bg-info text-light">
                        <tr>
                            ...
                            <th colspan="2" class="font-weight-bold align-middle text-center" width="100">Checklist Awal
                                Produksi</th>
        ...
        ?>
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                ...
                                <?php elseif ($row->checklist2 == 2 && $row->keterangan2 == NULL): ?>
                                <?= $row->keterangan2 ?: '-'; ?>
                                <?php else : ?>
                                <?= $row->keterangan2 ?: ''; ?>
                                <?php endif; ?>
            ...
            <div class="row mt-3">
                <div class="col">
                    <a href="<?= base_url('cekmesin_retort') ?>" class="btn btn-md btn-danger">
...
$(document).ready(function() {
    $(document).on('click', '.btn-check-oke', function(event) {
        ...
        $.post('<?= base_url('cekmesin_retort/check_akhir/'); ?>' + cek_uuid, {
            checklist: checklist
        }, function(res) {
    ...
    $(document).on('submit', '.form-keterangan', function(event) {
        ...
        $.post('<?= base_url('cekmesin_retort/keterangan/'); ?>' + uuid, {
                uuid: uuid,
    ...
    $(document).on('click', '.btn-approve-fr, .btn-approve-spv', function(event) {
        ...
        var url = isForeman ?
            '<?= base_url('cekmesin_retort/approval_cekmesin2'); ?>/' + uuid + '/' + area :
            '<?= base_url('cekmesin_retort/approval_cekmesin'); ?>/' + uuid + '/' + area;
