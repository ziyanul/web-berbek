            ...
            <tbody>
                ...
                foreach ($data as $row) {
                    ...
                    <tr>
                       <td><?= $no;?></td>
                       <td><?= $row->tanggal;?></td>
                       <td><?= $row->vrn;?> (<?= $row->keterangan;?>)</td>
                       <td>
                        <a href="<?= base_url('counter/detail/'.$row->uuid); ?>" class="btn btn-md btn-success shadow-sm"><i class="fa fa-book fa-sm text-white mr-2"></i>Detail</a>
                        <!-- <a href="<?= base_url('counter/document/'.$row->uuid); ?>" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-print mr-2"></i>Form</a> -->
