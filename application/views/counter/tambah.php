            ...
            <form class="user" action="<?= base_url('counter/tambah') ?>" method="post">
                <div class="row mb-3">
                    <div class="col-sm-6">
                        ...
                        <input type="date" name="date" class="form-control <?= form_error('date') ? 'invalid' : '' ?>" placeholder="" value="<?= set_value('date'); ?>">
                ...
                <div class="row mb-3 mb-sm-0">           
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <select class="form-control <?= form_error('varian') ? 'invalid' : '' ?>" name="varian" id="varian">
                            ...
                            <option value="0" <?= set_select('varian', 0);?>>OKEY</option>
                            <option value="1" <?= set_select('varian', 1);?>>CHAMP</option>
                        </select>
