<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url('sub_area') ?>"><i class="fas fa-arrow-left"></i> Sub Area</a></li>
  ...
  <div class="card shadow mb-4">
        <div class="card-body">
            <form class="user" action="<?= base_url('sub_area/edit/'.$lokasi->uuid) ?>" method="post">
                <div class="row">
                    <div class="col-sm-6 mb-2">
                        <label class="form-label">Nama Area</label><br>
                        <b><?= $lokasi->nama_area;?></b>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row" >
                    <div class="col-sm-12">
                        ...
                        <a href="<?= base_url('sub_area') ?>" class="btn btn-md btn-danger">
