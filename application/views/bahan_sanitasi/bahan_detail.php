<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <!-- Page Heading -->
        <h3 class="h3 mb-2 text-gray-800">Detail Permintaan Bahan Baku Sanitasi</h3>
        <?php
            $now = date('Y-m-d');
                if ($data[0]->tanggal == $now) {
            ?>
            <a href="<?= base_url('bahan_sanitasi/detail_'.$data[0]->tanggal.'/tambah'); ?>" class="btn btn-md btn-primary shadow-sm"><i
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class='align-middle text-center'>
                                <a href="<?= base_url('bahan_sanitasi/'.$row->uuid); ?>"
            ...
            <div class="col mt-3">
                <a href="<?= base_url('bahan_sanitasi') ?>" class="btn btn-md btn-danger">
...
$(document).ready(function() {
    $(document).on('click', '.btn-approve', function(event) {
        ...
        $.post('<?= base_url('bahan_sanitasi/approval_sanitasi'); ?>/' + uuid + '/' + area, function(
            res) {
