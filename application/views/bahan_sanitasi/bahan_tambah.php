<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        ...
        <?php
            ...
            ?>
            <li class="breadcrumb-item"><a href="<?= base_url($this->uri->segment(2)=='tambah'?'bahan_sanitasi':'bahan_sanitasi/'. $url) ?>"><i class="fas fa-arrow-left mr-2"></i>
            <?= ($this->uri->segment(2)=='tambah'?'Permintaan Bahan Baku Sanitasi':'Detail Permintaan Bahan Baku Sanitasi')?></a></li>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="user" action="<?= base_url('bahan_sanitasi/tambah') ?>" method="post">
                <div class="row mb-2">
                    <div class="col-sm-6">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <label class="form-label" for="qty_reservasi" id="qty-label"> Quantity Reservasi :<span class="text-danger">*</span>
                        </label>
                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        $url = $this->uri->segment(2);
                        ?>
                            <a href="<?= base_url($this->uri->segment(2)=='tambah'?'bahan_mp':'bahan_mp/'. $url) ?>" class="btn btn-md btn-danger">
...
$(document).ready(function () {
    ...
    $('select[name="item_barang"]').change(function () {
        var uuid = $(this).val();
        if (uuid) {
            $.get('<?= base_url('bahan_sanitasi/get_item_sanitasi/'); ?>' + uuid, function (res) {
                ...
                $('#qty-label').html(
                    'Quantity Reservasi (' + satuan + ') :<span class="text-danger">*</span>'
                );
            });
        } else {
