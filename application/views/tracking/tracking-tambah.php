<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Tambah Issue</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="user" action="<?= base_url('tracking/tambah/') ?>" method="post">
            

                <div class="row">
                    <div class="col-sm-6 mt-3">
                        <label class="form-label">Issue :<span class="text-danger">*</span></label>
                        <input type="text" name="issue" class="form-control <?= form_error('issue') ? 'invalid' : '' ?>" placeholder="Masukkan Issue" value="<?= set_value('issue'); ?>">
                ...
                <div class="row">
                    <div class="col-sm-6 mt-3">
                        ...
                        <input type="text" name="pic" class="form-control <?= form_error('pic') ? 'invalid' : '' ?>" placeholder="PIC" value="<?= set_value('pic'); ?>">
