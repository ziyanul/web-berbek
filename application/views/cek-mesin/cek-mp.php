<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="user" action="<?= base_url('cekmesin/checklistmp/'. $data->uuid); ?>" method="post">
                <div class="row">
                    <div class="col-sm-6 mb-4">
                        <label class="form-label">Nama Area <span class="text-danger">*</span></label>
                        <input class="form-control" type="text" name="area_name" value="MP" readonly>
...
$(document).ready(function() {
    ...
    $.get('<?= base_url('cekmesin/get_mesin_by_area/'); ?>' + area_uuid + '/' + t_planning_uuid,
        function(res) {
