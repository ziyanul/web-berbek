<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4 mr-2">
        <h2 class="h2 mb-2 text-gray-800">Pengecekan Mesin MP</h2>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="align-middle text-center"><?= $row->jumlah_mesin ?> dari 8</td>
                                <td>
                                    <a href="<?= base_url('cekmesin_mp/' . $row->uuid); ?>" class="btn btn-md btn-warning shadow-md btn-block font-weight-bold"><i class="fa fa-check mr-2 fa-sm text-white"></i>Ceklist Awal Proses</a>
                                    <a href="<?= base_url('cekmesin_mp/detailmp/' . $row->uuid . '/' . $this->mp); ?>" class="btn btn-md btn-success shadow-md btn-block font-weight-bold"><i class="fa fa-info mr-2 fa-sm text-white"></i>Detail</a>
                                    <?php if ($row->jumlah_mesin != 0) : ?>
                                        <a href="<?= base_url('cekmesin_mp/form-' . $row->uuid . '/' . $this->mp); ?>" class="btn btn-md btn-info shadow-md btn-block font-weight-bold" target="_blank">
