<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <!-- Page Heading -->
        <h3 class="h3 mb-2 text-gray-800">Detail Permintaan Bahan Baku Packing</h3>
        <?php
            $now = date('Y-m-d');
                if ($data[0]->tanggal == $now) {
            ?>
            <a href="<?= base_url('bahan_packing/detail_'.$data[0]->tanggal.'/tambah'); ?>" class="btn btn-md btn-primary shadow-sm"><i
                class="fas fa-plus fa-sm text-white"></i> Tambah</a>
        <?php } ?>
    </div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url('bahan_packing') ?>"><i class="fas fa-arrow-left"></i>
                    Permintaan Bahan Baku Packing</a></li>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class='align-middle text-center'>
                                <a href="<?= base_url('bahan_packing/'.$row->uuid); ?>"
            ...
            <div class="col mt-3">
                <a href="<?= base_url('bahan_packing') ?>" class="btn btn-md btn-danger">
...
$(document).ready(function() {
    $(document).on('click', '.btn-approve', function(event) {
        ...
        $.post('<?= base_url('bahan_packing/approval_packing'); ?>/' + uuid + '/' + area, function(
        res) {
