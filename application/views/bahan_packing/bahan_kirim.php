<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-2 text-gray-800">Penerimaan Bahan Baku Packing</h1>
    </div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= base_url('bahan_packing/detail_'. $nav->tanggal) ?>"></i> Detail
                    Permintaan Bahan Baku Packing</a></li>
...
$(document).ready(function() {
    $(document).on('click', '.btn-check-approval', function(event) {
        ...
        $.get('<?= base_url('bahan_packing/diterima/'); ?>' + uuid, function(res) {
