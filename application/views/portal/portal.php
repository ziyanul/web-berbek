    ...
    <div class="relative z-10 h-screen flex flex-col">
        ...
        <header class="max-w-7xl w-full mx-auto px-5 pt-3 pb-2">
            ...
            <div class="flex items-center justify-between">
                ...
                <div
                id="clock"
                class="glass rounded-2xl px-4 py-2 text-xs font-bold text-gray-700"
                >
            </div>
        ...
        <div class="flex flex-col items-center text-center">
            ...
            <div class="relative mt-4 w-full max-w-5xl">
                ...
                <div class="glass rounded-[28px] p-3">
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
                        ...
                        <div class="card glass rounded-[22px] p-3">
                            ...
                            <div class="relative z-10">
                                ...
                                <a
                                href="<?= base_url('yield/'); ?>" target="_blank"
                    ...
                    <div class="card glass rounded-[22px] p-3">
                        ...
                        <div class="relative z-10">
                            ...
                            <a
                            href="http://localhost/monitoring-mesin/paperless" target="_blank"
                ...
                <div class="card glass rounded-[22px] p-3">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-[11px] text-gray-600 leading-snug mb-3">
                            Monitoring Yield Produksi.
                        </p>

                        <a
                        href="http://cpi.berbek:8000/" target="_blank"
            ...
            <div class="card glass rounded-[22px] p-3">
                ...
                <div class="relative z-10">
                    ...
                    <a
                    href="http://localhost/monitoring-mesin/maintenance" target="_blank"
