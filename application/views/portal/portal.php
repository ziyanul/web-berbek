                ...
                <div class="relative mt-4 w-full max-w-5xl">
                    ...
                    <div class="glass rounded-[28px] p-3">
                        ...
                        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
                            ...
                            <!-- CARD -->
                            <div class="card glass rounded-[22px] p-3">
                                ...
                                <div class="relative z-10">
                                    ...
                                    <div class="flex items-center justify-between mb-3">
                                        ...
                                        <div
                                            class="w-11 h-11 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center shadow-lg">
                            ...
                            <div class="card glass rounded-[22px] p-3">
                                ...
                                <div class="relative z-10">
                                    ...
                                    <div class="flex items-center justify-between mb-3">
                                        ...
                                        <div
                                            class="w-11 h-11 rounded-xl bg-gradient-to-br from-cyan-500 to-sky-500 flex items-center justify-center shadow-lg">
                            ...
                            <div class="card glass rounded-[22px] p-3">
                                ...
                                <div class="relative z-10">
                                    ...
                                    <div class="flex items-center justify-between mb-3">
                                        ...
                                        <div
                                            class="w-11 h-11 rounded-xl bg-gradient-to-br from-red-500 to-orange-500 flex items-center justify-center shadow-lg">
                            ...
                            <div class="card glass rounded-[22px] p-3">
                                ...
                                <div class="relative z-10">
                                    ...
                                    <div class="flex items-center justify-between mb-3">
                                        ...
                                        <div
                                            class="w-11 h-11 rounded-xl bg-gradient-to-br from-amber-500 to-orange-500 flex items-center justify-center shadow-lg">
