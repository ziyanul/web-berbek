...
class bahan_packing_model extends CI_Model 
{
	...
	public function get_all()
	{
		...
		$this->db->where('area_uuid', $this->packing);
	...
	public function get_all_packing($tanggal)
	{
    ...
    // Wrap database names with backticks for `e-retort-dev`
    ...
    $this->db->where('bb.area_uuid', $this->packing);
	...
	public function get_item()
	{
			...
			$this->dbwarehouse->where('area_uuid', $this->packing);
    ...
    $year = date('Y');
    $today = date('Y-m-d');
    $area_uuid = $this->packing; // area_uuid yang ingin difilter
	...
	public function get_kirim_packing($bahan_uuid)
	{
	...
	public function get_form_packing($tanggal)
	{
	...
	public function approval_packing($tanggal, $area_uuid)
	{
		...
		$this->db->where('area_uuid', $this->packing); // Filter berdasarkan area_uuid
